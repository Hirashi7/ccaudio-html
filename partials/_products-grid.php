<a class="col-xs-12 col-sm-6 col-md-4 product-item text-center" href="/product.php">
    <picture>
...
<a class="col-xs-12 col-sm-6 col-md-4 product-item text-center" href="/product.php">
    <picture>
        <source type="image/webp" srcset="img/sluchawki5-xs.webp">
        <source type="image/jpeg" srcset="img/sluchawki5-xs.jpg">
...
<a class="col-xs-12 col-sm-6 col-md-4 product-item text-center" href="/product.php">
    <picture>
        <source type="image/webp" srcset="img/sluchawki6-xs.webp">
        <source type="image/jpeg" srcset="img/sluchawki6-xs.jpg">
...
<a class="col-xs-12 col-sm-6 col-md-4 product-item text-center" href="/product.php">
    <picture>
        <source type="image/webp" srcset="img/sluchawki7-xs.webp">
        <source type="image/jpeg" srcset="img/sluchawki7-xs.jpg">
...
<a class="col-xs-12 col-sm-6 col-md-4 product-item text-center" href="/product.php">
    <picture>
        <source type="image/webp" srcset="img/sluchawki8-xs.webp">
        <source type="image/jpeg" srcset="img/sluchawki8-xs.jpg">
        <img srcset="img/sluchawki8.jpg" alt="Sluchawki 8" class="img-fluid">
    </picture>
    <p class="product-item__title">BOSE QUIETCOMFORT 35</p>
    <p class="product-item__price"><strong>1219,95 <span class="product-item__currency">PLN</span></strong></p>
</a>
<a class="col-xs-12 col-sm-6 col-md-4 product-item text-center" href="/product.php">
    <picture>
        <source type="image/webp" srcset="img/sluchawki9-xs.webp">
        <source type="image/jpeg" srcset="img/sluchawki9-xs.jpg">
        <img srcset="img/sluchawki9.jpg" alt="Sluchawki 9" class="img-fluid">
    </picture>
    <p class="product-item__title">BOSE QUIETCOMFORT 35</p>
    <p class="product-item__price"><strong>1219,95 <span class="product-item__currency">PLN</span></strong></p>
</a>